...
void aes_inv_mix_columns(unsigned char * state) {
    for (int i = 0; i < 4; i++) {
        ...
        char r0 = aes_x_times(*a0, 0x0E) ^ aes_x_times(*a1, 0x0B) ^ aes_x_times(*a2, 0x0D) ^ aes_x_times(*a3, 0x09);
        char r1 = aes_x_times(*a0, 0x09) ^ aes_x_times(*a1, 0x0E) ^ aes_x_times(*a2, 0x0B) ^ aes_x_times(*a3, 0x0D);
        char r2 = aes_x_times(*a0, 0x0D) ^ aes_x_times(*a1, 0x09) ^ aes_x_times(*a2, 0x0E) ^ aes_x_times(*a3, 0x0B);
        char r3 = aes_x_times(*a0, 0x0B) ^ aes_x_times(*a1, 0x0D) ^ aes_x_times(*a2, 0x09) ^ aes_x_times(*a3, 0x0E);
