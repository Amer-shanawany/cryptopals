...
void test_aes_shiftrows() {
    unsigned char state[] = {0x85, 0x82, 0x85, 0x8F, 0x6E, 0x19, 0xEA, 0xF6,
...
void test_aes_inv_shiftrows() {
    ...
    unsigned char expected[] = {0x85, 0xE0, 0xBC, 0xF6, 0x6E, 0x82, 0x26, 0xC2,
...
void test_aes_mix_columns() {
    unsigned char state[] = {0x85, 0x19, 0xBC, 0xED, 0x6E, 0x13, 0x26, 0x8F,
                             0x61, 0xE0, 0x85, 0xF6, 0x3C, 0x82, 0xEA, 0xC2};

    unsigned char expected[] = {0x6B, 0x85, 0xD3, 0xF0, 0x40, 0xAD, 0xBB, 0x82,
...
void test_aes_encrypt_AES128() {
    ...
    unsigned char expected[] = {0x39, 0x25, 0x84, 0x1D, 0x02, 0xDC, 0x09, 0xFB,
...
void test_aes_decrypt_AES128() {
    char input[] = {0x39, 0x25, 0x84, 0x1D, 0x02, 0xDC, 0x09, 0xFB,
                    0xDC, 0x11, 0x85, 0x97, 0x19, 0x6A, 0x0B, 0x32};
...
CUNIT_CI_RUN("test_aes", CUNIT_CI_TEST(test_aes_key_expansion),
